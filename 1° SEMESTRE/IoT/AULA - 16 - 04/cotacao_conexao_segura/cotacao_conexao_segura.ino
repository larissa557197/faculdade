...
const char* ssid     = "motorola g(20)";     // your network SSID (name of wifi network)
const char* password = "@motogMaria"; // your network password
...
void loop() {
  if ((millis() - lastTime) > timerDelay) { // Verifica o timer de 10 segundos.
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      // os valores do euro, dolar e bitcoin
      Serial.println("========================================================================");

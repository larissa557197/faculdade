...
#define DHT_pin 27 // pino do ESP32 onde o pino DATA será conetado 
#define DHT_type DHT11 //tipo de sensor  

DHT dht(DHT_pin, DHT_type); //um objeto
#define boardLED 2 // LED onboard

// Identificadores
const char* ID        = "LaMa";
const char* moduleID  = "ESP32 - 001";
...
// MQTT Broker
const char* BROKER_MQTT  = "74.179.84.66"; //ip da vm
const int   BROKER_PORT  = 1883; //porta do broker
const char* mqttUser     = "gs2024"; //user
const char* mqttPassword = "q1w2e3r4"; //senha
...
//-----------------------------------------------------------
//Função para ler dados do DHT11(sensor de temperatura)
void leituraSensor(){
